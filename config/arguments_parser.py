...
def args(attack_run, additional_args: dict = None):
    ...
    parser.add_argument('--enable_jit', dest='enable_jit', action='store_true')
    parser.add_argument('--use_resource_variables', dest='use_resource_variables', action='store_true')
